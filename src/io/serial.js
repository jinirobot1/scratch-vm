...
class SR extends JSONRPC {
    ...
    constructor (runtime, extensionId, peripheralOptions, connectCallback, resetCallback = null, messageCallback) {
        ...
        this._socket = runtime.getScratchLinkSocket('SR');
    ...
    didReceiveCall (method, params) {
        ...
        case 'didDiscoverPeripheral':
            //log.error(`didDiscoverPeripheral`);
        ...
        case 'userDidPickPeripheral':
            //log.error(`userDidPickPeripheral`);
            this._availablePeripherals[params.peripheralId] = params;
            this._runtime.emit(
        ...
        case 'userDidNotPickPeripheral':
            //log.error(`userDidNotPickPeripheral`);
            this._runtime.emit(
        ...
        case 'didReceiveMessage':
            //log.error(`didReceiveMessage`);
            this._messageCallback(params); // TODO: refine?
            break;
        default:
            //log.error(`didReceiveCall - default`);
            return 'nah';
        }
    }
     ...
     */
    handleDisconnectError (e) {/* e */
        
        //log.error(`handleDisconnectError`);
        log.error(`SERIAL error: ${JSON.stringify(e)}`);
    ...
    _handleDiscoverTimeout () {
        //log.error(`_handleDiscoverTimeout`);
        if (this._discoverTimeoutID) {
            window.clearTimeout(this._discoverTimeoutID);
        }
