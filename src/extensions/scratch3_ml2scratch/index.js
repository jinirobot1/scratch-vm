...
const Message = {
  ...
  toggle_classification: {
    ...
    'ko': '분류 전환하기 [CLASSIFICATION_STATE]',
  ...
  set_classification_interval: {
    ...
    'ko': '[CLASSIFICATION_INTERVAL]초로 분류 간격 조정',
  ...
  first_training_warning: {
    ...
    'ko': '초기 학습 설정 시간이 필요합니다. 잠시 기다려 주세요.',
    'zh-cn': '第一项研究需要一段时间，所以不要一次又一次地点击。',
    'zh-tw': '第一次訓練需要一段時間，請稍後，不要一直點擊。'
  }
}

const AvailableLocales = ['en', 'ja', 'ja-Hira', 'zh-cn', 'zh-tw','ko'];
