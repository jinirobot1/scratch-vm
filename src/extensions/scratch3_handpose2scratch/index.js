...
class Scratch3Hand2ScratchBlocks {
    get LANDMARK_MENU () {
      return [
        {
          text: Message.landmarks[0][this._locale]+'(1)',
          value: '1'
        },
        {
          text: Message.landmarks[1][this._locale]+'(2)',
          value: '2'
        },
        {
          text: Message.landmarks[2][this._locale]+'(3)',
          value: '3'
        },
        {
          text: Message.landmarks[3][this._locale]+'(4)',
          value: '4'
        },
        {
          text: Message.landmarks[4][this._locale]+'(5)',
          value: '5'
        },
        {
          text: Message.landmarks[5][this._locale]+'(6)',
          value: '6'
        },
        {
          text: Message.landmarks[6][this._locale]+'(7)',
          value: '7'
        },
        {
          text: Message.landmarks[7][this._locale]+'(8)',
          value: '8'
        },
        {
          text: Message.landmarks[8][this._locale]+'(9)',
          value: '9'
        },
        {
          text: Message.landmarks[9][this._locale]+'(10)',
          value: '10'
        },
        {
          text: Message.landmarks[10][this._locale]+'(11)',
          value: '11'
        },
        {
          text: Message.landmarks[11][this._locale]+'(12)',
          value: '12'
        },
        {
          text: Message.landmarks[12][this._locale]+'(13)',
          value: '13'
        },
        {
          text: Message.landmarks[13][this._locale]+'(14)',
          value: '14'
        },
        {
          text: Message.landmarks[14][this._locale]+'(15)',
          value: '15'
        },
        {
          text: Message.landmarks[15][this._locale]+'(16)',
          value: '16'
        },
        {
          text: Message.landmarks[16][this._locale]+'(17)',
          value: '17'
        },
        {
          text: Message.landmarks[17][this._locale]+'(18)',
          value: '18'
        },
        {
          text: Message.landmarks[18][this._locale]+'(19)',
          value: '19'
        },
        {
          text: Message.landmarks[19][this._locale]+'(20)',
          value: '20'
        },
        {
          text: Message.landmarks[20][this._locale]+'(21)',
          value: '21'
        }
      ]
      /*
    ...
    getInfo () {
        ...
        //log.console(this._locale);
        return {
            id: 'hand2scratch',
            name: Message.name[this._locale],//'Hand2Scratch',
...
module.exports = Scratch3Hand2ScratchBlocks;
